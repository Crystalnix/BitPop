...
class ChatPopup : public BrowserBubble,
                  public BrowserBubble::Delegate,
                  public ExtensionView::Container,
                  public NotificationObserver,
                  public base::RefCounted<ChatPopup> {
 public:
  ...
  class Observer {
   public:
    ...
    virtual void ChatPopupIsClosing(ChatPopup* popup) {}
  };
  ...
  static ChatPopup* Show(const GURL& url, Browser* browser,
