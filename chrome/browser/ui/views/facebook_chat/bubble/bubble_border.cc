...
// static
struct BitpopBubbleBorder::BorderImages* BitpopBubbleBorder::normal_images_ = NULL;
struct BitpopBubbleBorder::BorderImages* BitpopBubbleBorder::shadow_images_ = NULL;

// The height inside the arrow image, in pixels.
static const int kArrowInteriorHeight = 7;

BitpopBubbleBorder::BitpopBubbleBorder(ArrowLocation arrow_location, Shadow shadow)
...
gfx::Rect BitpopBubbleBorder::GetBounds(const gfx::Rect& position_relative_to,
...
int BitpopBubbleBorder::GetBorderThickness() const {
...
void BitpopBubbleBorder::DrawArrowInterior(gfx::Canvas* canvas,
                                     float tip_x,
                                     float tip_y) const {
...
void BitpopBubbleBackground::Paint(gfx::Canvas* canvas, views::View* view) const {
