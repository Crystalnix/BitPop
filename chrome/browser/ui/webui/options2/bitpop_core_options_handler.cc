...
void BitpopCoreOptionsHandler::Observe(int type,
...
DictionaryValue* BitpopCoreOptionsHandler::CreateValueForPref(
    const PrefService::Preference* pref,
    const PrefService::Preference* controlling_pref) {
...
void BitpopCoreOptionsHandler::StopObservingPref(const std::string& path) {
